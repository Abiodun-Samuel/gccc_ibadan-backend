...
class BulkCreateMembersRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'members.*.status' => 'nullable|in:active,inactive,pending',
    ...
    public function messages(): array
    {
        return [
            ...
            'members.*.password.required' => 'Password is required for all members',
    ...
    public function attributes(): array
    {
        ...
        if (is_array($this->members)) {
            foreach ($this->members as $index => $member) {
                ...
                $attributes["members.{$index}.password"] = "member #{$memberNumber} password";
                ...
                $attributes["members.{$index}.status"] = "member #{$memberNumber} status";
                $attributes["members.{$index}.date_of_birth"] = "member #{$memberNumber} date of birth";
            }
        }
